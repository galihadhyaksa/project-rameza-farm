    ...
    <div class="container py-5">
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-4">
          <h3 class="fw-bold">Rameza Egg Farm</h3>
          <p>
            Peternakan ayam petelur yang menyediakan telur segar berkualitas,
            bibit unggul, dan layanan konsultasi peternakan.
          </p>
        </div>
        ...
        <div class="col-md-2 mb-4">
          <h5>Kontak</h5>
          <p class="mb-1">📍 Jember</p>
          <p class="mb-1">📞 08xxxxxxxxxx</p>
          <p class="mb-1">🕒 07.00–16.00</p>
        </div>
